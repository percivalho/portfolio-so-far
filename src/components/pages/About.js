...
export default function About() {
  return (
    <div style={mainstyle}>
      ...
      <p>Here are some of the notable projects I've accomplished during the BootCamp:</p>
      <ul>
        <li><strong>Refactoring Project:</strong> Here, my primary focus was on enhancing a website's structure using Semantic HTML Elements.</li>
        <li><strong>Upcoming Endeavors:</strong> I'm eagerly gearing up for Project A, Project B, and Project C.</li>
      </ul>
